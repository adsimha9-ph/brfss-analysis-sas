...
ods pdf file="/home/u64219640/brfss_results.pdf";

/*------------------------------------------------------------*/
/* Survey-weighted frequency: Income vs Poor Health          */
/*------------------------------------------------------------*/
title "Income and Poor Health (Row %)";
...
/*------------------------------------------------------------*/
title "Race and Poor Health (Row %)";
...
/*------------------------------------------------------------*/
title "Odds Ratios for Poor Health by Income and Race";

ods select OddsRatios Type3;
